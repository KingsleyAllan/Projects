...
<body>
    ...
    <h1 class="heading">PANDEM TOYOTA A90 SUPRA</h1>
    <br>

    <table class="centre">
        <tr>
            <th>Pandem - Toyota A90 Supra Complete Body kit</th>
            <td>US $</td>
        </tr>
        <tr>
            <td>FRONT LIP / FRONT CANARD / FRONT SPLITTER / SIDE SKIRT / FRONT FENDERS / REAR FENDERS / GT WING / DUCK BILL</td>
            <td><b>$9,000</b></td>
        </tr>
    </table>
